...
<body class="bg-gradient-to-br from-yellow-100 to-yellow-200 min-h-screen flex flex-col">
    <div class="flex items-center justify-center mt-20">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <form method="POST" action="">
                ...
                <button type="submit"
                    class="w-full bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-md transition duration-300 flex items-center justify-center">
            ...
            <div class="text-center mt-6">
                <p class="text-yellow-700">Sudah punya akun?
                    <a href="login.php" class="text-yellow-800 font-bold hover:underline flex items-center justify-center">
    ...
    echo generateFooter($categories);
    ?>
</body>
<script>
    ...
    toggleConfirmPassword.addEventListener('click', function(e) {
        ...
        if (type === 'password') {
            toggleIconConfirmPassword.classList.add('fa-eye-slash');
            toggleIconConfirmPassword.classList.remove('fa-eye');
        } else {
            toggleIconConfirmPassword.classList.add('fa-eye');
            toggleIconConfirmPassword.classList.remove('fa-eye-slash');
        }
    });
</script>
