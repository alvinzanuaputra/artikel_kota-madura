    ...
    if (empty($judul) || empty($isi)) {
        ...
        try {
            ...
            if ($error) {
                ...
                $formatted_timestamp = $datetime->format('Y-m-d H:i:s');
                $stmt = $pdo->prepare("INSERT INTO artikel (judul, isi, gambar, tanggal) VALUES (?, ?, ?, ?)");
                $stmt->execute([$judul, $isi, $gambar_nama_file_temp, $formatted_timestamp]); // Simpan nama sementara
...
<body class="bg-gradient-to-br from-yellow-50 to-yellow-100 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="index.php?logout=1" class="bg-yellow-800 hover:bg-yellow-900 text-white px-4 py-2 rounded-md transition duration-300 flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form method="POST" action="" enctype="multipart/form-data"> <!-- Tambahkan enctype -->
                ...
                <div class="flex space-x-4">
                    <button type="submit" 
                            class="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 px-6 rounded-md transition duration-300 flex items-center">
                        <i class="fas fa-save mr-2"></i> Simpan Artikel
                    </button>
                    <a href="index.php" 
                       class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded-md transition duration-300 inline-block flex items-center">
    ...
    <!-- Footer -->
    <?php echo generateFooter($all_categories, true); ?>
</body>
</html>