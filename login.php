    ...
    <div class="flex items-center justify-center mt-20">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            <div class="text-center mb-8">
                ...
                <p class="text-yellow-600">Masuk untuk menjadi penulis artikel pertama</p>
            </div>
            ...
            <div class="text-center mt-6">
                <p class="text-yellow-700">Belum punya akun?
                    <a href="register.php" class="text-yellow-800 font-bold hover:underline flex items-center justify-center">
                        <i class="fas fa-user-plus mr-2"></i> Daftar di sini
                    </a>
                </p>
            </div>
        </div>
